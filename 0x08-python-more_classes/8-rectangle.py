...
class Rectangle:
    ...
    print_symbol = "#"  # Class attribute to define the print symbol
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Raises:
            TypeError: If either rect_1 or renstance of Rectangle.

        Returns:
            Rectangle: The bigger rectangle, have the same area value.
        """
